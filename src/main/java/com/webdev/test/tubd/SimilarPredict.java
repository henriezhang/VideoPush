...
/**
 * Created by henriezhang on 2014/5/23.
 */
public class SimilarPredict {
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 1; !endDs.equals(formatter.format(cd1.getTime())) && i < 360; i++) {
    ...
    public static class BayesPredictReducer
        ...
        private double similarProbability(NewsUserClick uPredict, ArticleInfo pNews, List<NewsUserClick> hist) {
            ...
            for (num = 0; num < hist.size(); num++) {
                similarity += pNews.similarTo(pushNews.get(hist.get(0).getAid()));
            }
