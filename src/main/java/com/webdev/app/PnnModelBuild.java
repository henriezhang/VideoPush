...
public class PnnModelBuild {
    public static void main(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "PnnModelBuild");
        job.setJarByClass(PnnModelBuild.class);
        job.setMapperClass(PnnModelBuildMapper.class);
        job.setReducerClass(PnnModelBuildReducer.class);
    ...
    public static class PnnModelBuildMapper
    ...
    public static class PnnModelBuildReducer
